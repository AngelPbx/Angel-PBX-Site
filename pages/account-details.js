...
function AccountDetails() {
  ...
  async function handleSubmit() {
    ...
    if (
      ...
      if (apiData.status) {
        setLoading(false);
        setSubmitEmail(apiData.data.email);
        setLeadId(apiData.data.id);
        setOpenOTP(true);
  ...
  return (
    <div className="main">
      {openOTP ? (
        <OTPInput email={submitEmail} id={routerData.id} leadId={leadId} />
      ) : (
        <>
                            ...
                            <div className="row">
                              ...
                              <div className="col-12">
                                <div className="content_wraper">
                                  <p>
                                    You authorize Angel PBX, pursuant to the
                                    Terms of Service, to automatically charge
                                    the above credit card each month for the
                                    plan fee and any applicable taxes, fees and
                                    charges. Your billing period starts today.
                                    Services and billing will continue until
                                    canceled.
                                  </p>
                                  <div className="payment_flexbox">
                                    ...
                                    <label htmlFor="vehicle1">
                                      ...
                                      are entering into a 1-year contract for
                                      which Angel PBX Business will charge you
                                      $43.04 per month, plus taxes, fees and
                                      usage charges. If you cancel before the
                                      end of your contract period on May 9,
                                      2025, you will be responsible for an early
                                      termination fee.
                                    </label>
                                  </div>
                                  <div className="payment_flexbox">
                                    ...
                                    />
                                    <label htmlFor="vehicle1">
                                      I have read and accept the Emergency
                                      Services Policy and Acknowledgement.{" "}
                                      <b>
                                        {" "}
                                        Please scroll above before accepting.
                                      </b>
                                    </label>
                                  </div>
                                  <div className="payment_flexbox">
