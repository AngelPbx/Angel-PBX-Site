...
function Payment() {
  ...
  async function handleSubmit() {
    ...
    if(!(cardDetails.cardName === "") && !(cardDetails.expiryDate === "") && !(cardDetails.cvv.length < 3 || cardDetails.cvv.length > 6) && cardValidator.number(cardDetails.cardNumber).isValid){
      setLoading(true)
        ...
        const parsedData ={
            ...
            exp_year:Number(String(year).slice(0,2)+String(cardDetails.expiryDate.split("/")[1])),
            cvc:cardDetails.cvv,
                        ...
                        <div className="row">
                          <div className="col-12">
                            <div className="form-group">
                              ...
                              />
                              <small className="error">
                                {erroredInputs.expiryDate ? "Enter correct Expiry Date" : ""}
                              </small>
                            </div>
                          </div>
                        </div>
