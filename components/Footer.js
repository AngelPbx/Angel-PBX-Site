...
function Footer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Send email to an API (Replace with your endpoint)
      const response = await generalPostFunction(`subscriber-email`, { email });
          ...
          <div className="row">
            <div className="col-12">
              <div className="up_footerbox">
                ...
                {/* Success message positioned to the right */}
                {message && (
                  <ul className='email-sent-message'>
                    {message}
                  </ul>
                )}
              </div>
          ...
          <ul>
            ...
            <li>
              <div className="cookies_box">
                <p>
                  @{(new Date()).getFullYear()} I Powered by Angelpbx  LLC | DBA - Angelpbx All Right
                  Reserved
                </p>
              </div>
            </li>
